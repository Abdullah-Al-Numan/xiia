...
const Blog = () => {
  const blogListData: BlogCardProps[] = [
    {
      authorAvatarSrc: '/images/tanvir.jfif',
    ...
    {
      authorAvatarSrc: '/images/udara.jfif',
      authorName: 'Udara Damitha',
      launchDate: 'Mar 11',
    ...
    {
      authorAvatarSrc: '/images/numan1.jfif',
      authorName: 'Abdullah AL Numan',
      launchDate: 'Mar 10',
    ...
    {
      authorAvatarSrc: '/images/ana.jfif',
      authorName: 'Ana Sofia Castellanos',
      launchDate: 'Feb 20',
    ...
    {
      authorAvatarSrc: '/images/numan.jfif',
      authorName: 'Abdullah AL Numan',
      launchDate: 'Jan 28',
      lead: 'Get accurate error messages when the application crashes',
      readTime: '12 min',
      thumbnailSrc: '/images/blog-thumbnail-6.webp',
      title: 'Monitor your application when errors occur',
    },
  ]
  return (
    <PageTemplate title='Blogs - XIIA'>
      ...
      <section className="grid place-items-center gap-16">
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-10 sm:gap-x-5">
          {blogListData.map((data) => {
            return (
              <Link href="/blog" key={randomString(64)}>
                <div className='hover:cursor-pointer' data-aos="fade-up">
                  <BlogCard
